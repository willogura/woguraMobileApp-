...
class ToDoTableViewController: UITableViewController, NSFetchedResultsControllerDelegate, ToDoItemDelegate {
    ...
    func didSaveItem(_ customer: Customer)
    {
        ...
        let itemToInsert = ["customerName": customer.customerName, "complete": false, "__createdAt": Date(), "address1": customer.address1, "address2": customer.address2, "zip": customer.zip, "city": customer.city, "customerState" : customer.state] as [String : Any]
